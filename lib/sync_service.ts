...
class SyncService {
    ...
    async pushAll(onProgress?: (msg: string) => void) {
        ...
        try {
            ...
            // await this.pushTable(db.apiKeys, 'api_keys'); // Sync API Keys (DISABLED TEMPORARILY FOR RECOVERY)
    ...
    async restoreFromCloud(onProgress?: (msg: string) => void, preventReload: boolean = false) {
        try {
            ...
            // await this.pullTable(db.apiKeys, 'api_keys'); // DISABLED TEMPORARILY FOR RECOVERY
